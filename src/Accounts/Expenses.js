...
const categories = ['Electricity', 'Maintenance', 'Staff Salary', 'Lab Equipment', 'Library Books', 'Canteen', 'Security', 'Printing', 'Events', 'Transport'];
...
const initExpenses = [
  { id: 1, title: 'Monthly Electricity Bill', category: 'Electricity', amount: 45000, date: '2025-03-05', vendor: 'BESCOM', bill: 'ELEC-2025-03', status: 'Approved' },
  { id: 2, title: 'Server Room AC Repair', category: 'Maintenance', amount: 12000, date: '2025-03-07', vendor: 'CoolTech Services', bill: 'MNT-2025-12', status: 'Pending' },
  { id: 3, title: 'New Lab Computers (5 units)', category: 'Lab Equipment', amount: 250000, date: '2025-03-01', vendor: 'Dell India', bill: 'LAB-2025-05', status: 'Approved' },
  { id: 4, title: 'Books for Central Library', category: 'Library Books', amount: 35000, date: '2025-02-28', vendor: 'Bookpoint', bill: 'LIB-2025-08', status: 'Approved' },
  { id: 5, title: 'Annual Day Event', category: 'Events', amount: 80000, date: '2025-02-25', vendor: 'Event Matrix', bill: 'EVT-2025-02', status: 'Approved' },
  { id: 6, title: 'Diesel for Generator', category: 'Maintenance', amount: 18000, date: '2025-03-08', vendor: 'HP Petrol', bill: 'MNT-2025-18', status: 'Approved' },
];
...
export default function Expenses() {
  ...
  const handleSave = () => {
    setExpenses([{ ...form, id: Date.now(), amount: parseInt(form.amount) || 0, status: 'Pending' }, ...expenses]);
    setShowForm(false);
