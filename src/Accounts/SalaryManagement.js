...
const initStaff = [
  { id: 'FAC001', name: 'Dr. Ramesh Kumar', dept: 'Engineering', role: 'Professor', basic: 80000, hra: 20000, da: 8000, pf: 9600, tax: 6000, net: 92400, month: 'February 2025', status: 'Paid' },
  { id: 'FAC002', name: 'Prof. Sunita Sharma', dept: 'Management', role: 'Assoc. Professor', basic: 65000, hra: 16250, da: 6500, pf: 7800, tax: 4500, net: 75450, month: 'February 2025', status: 'Paid' },
  { id: 'FAC003', name: 'Dr. Arjun Nair', dept: 'Computer Science', role: 'Assistant Professor', basic: 55000, hra: 13750, da: 5500, pf: 6600, tax: 3200, net: 64450, month: 'February 2025', status: 'Pending' },
  { id: 'STF001', name: 'Meena Krishnan', dept: 'Administration', role: 'Office Manager', basic: 35000, hra: 8750, da: 3500, pf: 4200, tax: 1500, net: 41550, month: 'February 2025', status: 'Paid' },
  { id: 'STF002', name: 'Raj Patil', dept: 'Accounts', role: 'Accountant', basic: 30000, hra: 7500, da: 3000, pf: 3600, tax: 1200, net: 35700, month: 'February 2025', status: 'Paid' },
  { id: 'STF003', name: 'Pradeep Singh', dept: 'Library', role: 'Librarian', basic: 28000, hra: 7000, da: 2800, pf: 3360, tax: 900, net: 33540, month: 'February 2025', status: 'Pending' },
];
...
export default function SalaryManagement() {
  ...
  const handleSave = () => {
    setStaff([{ ...form, basic: +form.basic, hra: +form.hra, da: +form.da, pf: +form.pf, tax: +form.tax, net: net(form), status: 'Pending' }, ...staff]);
    setShowForm(false);
