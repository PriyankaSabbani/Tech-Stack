...
export default function Receipt() {
  ...
  const [receipts, setReceipts] = useState([
    { receiptNo: 'RCP-2025-4821', studentId: 'STU001', studentName: 'Arjun Sharma', course: 'B.Tech CSE', amount: 45000, paymentDate: '2025-03-10', paymentMode: 'UPI', feeType: 'Tuition Fee' },
    { receiptNo: 'RCP-2025-3910', studentId: 'STU002', studentName: 'Priya Nair', course: 'MBA Finance', amount: 38000, paymentDate: '2025-03-10', paymentMode: 'Card', feeType: 'Tuition Fee' },
    { receiptNo: 'RCP-2025-3201', studentId: 'STU003', studentName: 'Rahul Verma', course: 'B.Com', amount: 22000, paymentDate: '2025-03-09', paymentMode: 'Cash', feeType: 'Tuition Fee' },
  ]);

  const handleGenerate = () => {
    setReceipts([{ ...form, amount: parseInt(form.amount) || 0 }, ...receipts]);
    setShowReceipt(true);
  };
