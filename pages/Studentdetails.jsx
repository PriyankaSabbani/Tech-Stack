...
function StudentDetails() {
  ...
  const liveStudent = user?.student || {};
  ...
  const student = useMemo(() => ({
    ...
    address: {
      doorno: "12-45",
      street: typeof liveStudent.address === "string" ? liveStudent.address : "Main Street",
      village: "Kompally",
      mandal: "Medchal",
  ...
  }), [liveStudent.name, liveStudent.id, liveStudent.address]);

  const statCards = useMemo(() => [
    { icon: "🎓", label: "Program", value: student.program, bg: BLUE_SOFT },
    { icon: "🪪", label: "Roll No", value: student.roll, bg: RED_SOFT },
    { icon: "📅", label: "Batch", value: student.batch, bg: BLUE_SOFT },
    { icon: "🏫", label: "Grade", value: `Grade ${liveStudent.grade || ""}`, bg: "#f0f0f0" },
  ], [student.program, student.roll, student.batch, liveStudent.grade]);
    ...
    <div style={{ backgroundColor: GRAY_BG, minHeight: "100vh", fontFamily: "'Segoe UI', sans-serif", color: BLACK }}>
      <div className="container-lg py-4 px-3 px-md-4">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
          <div style={{ width: "5px", height: "34px", borderRadius: "3px", flexShrink: 0, background: `linear-gradient(180deg, ${RED} 0%, ${BLUE} 100%)` }} />
        ...
        <div className="row g-4">
            ...
            <div style={{ background: NAVY, borderRadius: "16px", boxShadow: "0 4px 20px rgba(13,27,62,0.15)", height: "100%" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "28px 20px" }}>
                ...
                <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "16px" }}>
                  <QuickInfo icon="📞" label="Student Phone" value={student.studentPhone} />
                  <QuickInfo icon="👨‍👧" label="Parent Contact" value={student.parentPhone} />
                  <QuickInfo icon="🎂" label="Date of Birth" value={student.dob} />
                  <QuickInfo icon="🗂️" label="Admitted On" value={student.admissionDate} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-md-8 col-lg-9" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ borderRadius: "14px", boxShadow: "0 2px 12px rgba(13,27,62,0.07)", overflow: "hidden", background: "#fff" }}>
              <div style={cardHeaderStyle}><span>👤</span><span>Personal Information</span></div>
            ...
            {/* Contact Information */}
            <div style={{ borderRadius: "14px", boxShadow: "0 2px 12px rgba(13,27,62,0.07)", overflow: "hidden", background: "#fff" }}>
              <div style={cardHeaderStyle}><span>📞</span><span>Contact Information</span></div>
              <div className="p-3 p-md-4">
                <div className="row g-3">
            ...
            {/* Residential Address */}
            <div style={{ borderRadius: "14px", boxShadow: "0 2px 12px rgba(13,27,62,0.07)", overflow: "hidden", background: "#fff" }}>
              <div style={cardHeaderStyle}><span>📍</span><span>Residential Address</span></div>
              <div className="p-3 p-md-4">
                <div style={{ background: NAVY, color: "#c8d4ec", fontSize: "13px", fontWeight: 500, lineHeight: 1.6, padding: "12px 16px", borderRadius: "8px", borderLeft: `4px solid ${RED}`, marginBottom: "20px" }}>
                  🏠 {fullAddress}
                </div>
                <div className="row g-3">
